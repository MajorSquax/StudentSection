...
# ------------------------------
@app.route('/flaskapi/users/login', methods=['POST', 'GET'])
def login():
...
# ------------------------------
@app.route('/flaskapi/users/<string:user_id>/third_party', methods=['POST'])
...
# ------------------------------
@app.route('/flaskapi/Attend', methods=['POST'])
...
# ------------------------------
@app.route('/flaskapi/attendance', methods=['GET'])
def get_attendance():
    if 'user_id' not in session:
        return jsonify({"error": "Not authenticated"}), 401
...
# ------------------------------
@app.route('/flaskapi/tickets/mine', methods=['GET'])
def get_my_tickets():
    """
...
# ------------------------------
@app.route('/flaskapi/tickets/<ticket_id>/purchase/intent', methods=['POST'])
...
# ------------------------------
@app.route('/flaskapi/tickets/<ticket_id>/purchase/confirm', methods=['POST'])
