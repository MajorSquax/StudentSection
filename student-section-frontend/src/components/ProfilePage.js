...
function ProfilePage() {
  ...
  useEffect(() => {
    if (!userId) return;
    axios
      .get('https://studentsection.xyz/flaskapi/tickets/mine', { withCredentials: true })
      .then((res) => {
  ...
  const handleSave = (e) => {
    ...
    axios
      .put(`https://studentsection.xyz/flaskapi/users/${userId}/profile`, profile, { withCredentials: true })
      .then(() => {
  ...
  const handleConnectUc = (e) => {
    ...
    axios
      ...
      .then((res) => {
        ...
        return axios.post('https://studentsection.xyz/flaskapi/tickets/import', {}, { withCredentials: true });
      })
      .then((importRes) => {
